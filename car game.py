...
pygame.mixer.music.load("C:\Dr. Driving Theme Song.mp3")
g_display = pygame.display.set_mode((dis_Width, dis_height))
pygame.display.set_caption("CAR RACE GAME")
clock = pygame.time.Clock()
carimg = pygame.image.load('C:\car4.png') 

backgroundimg = pygame.image.load("C:\\background.png")
carimg_small = pygame.transform.scale(carimg, (50, 100))
intro_background = pygame.image.load("C:\\background2.jpg")
intro_background_sl = pygame.transform.scale(intro_background, (600, 600))
instruction_background = pygame.image.load("C:\\background4.png")
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_object("RACE RUSH-CAR CRAZE", largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textsurf, textrect = text_object("This is a car game in which you need to avoid the oncoming cars", smalltext)
        ...
        rtexrSurf, rtextRect = text_object("B : BRAKE", smalltext)
...
def paused():
    ...
    while pause:
        ...
        TextSurf, TextRect = text_object("PAUSED", mediumtext)
...
def countdown_background():
    ...
    text = font.render("DODGEE: 0", True, black)
    score = font.render("SCORE: 0", True, red)
    g_display.blit(text, (0, 90))
...
def obstracle(obs_startx, obs_starty, obs):
    if obs == 0:
        obs_pic = pygame.image.load("C:\car0.png")
    elif obs == 1:
        obs_pic = pygame.image.load("C:\car2.png")
    elif obs == 2:
        obs_pic = pygame.image.load("C:\car3.png")
    elif obs == 3:
        obs_pic = pygame.image.load("C:\car5.png")
    elif obs == 5:
        obs_pic = pygame.image.load("C:\\bike.png")
    elif obs == 6:
        obs_pic = pygame.image.load("C:\\racecar.png")
    else:
        obs_pic = pygame.image.load("C:\\car.png")
...
def score_system(passed, score):
    ...
    text = font.render("PASSEE: " + str(passed), True, blue)
    score = font.render("SCORE: " + str(score), True, red)
    g_display.blit(text, (0, 100))
    g_display.blit(score, (0, 50))
    ...
    while not bumpeE:
        ...
        if y < obs_starty + obs_height:
            if x > obs_startx and x < obs_startx + obs_width or x + car_width > obs_startx and x + car_width < obs_startx + obs_width:
                crash()
        button("Pause", 450, 0, 150, 50, red, bright_red, "pause")
        pygame.display.update()
        clock.tick(50)
